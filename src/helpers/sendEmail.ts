...
export const sendEmail = async (email: string, username: string, verificationCode: number) => {
    try {
        ...
        const info = await transporter.sendMail({
            ...
            to: email,
            subject: "Verification Code Anonymous Feed",
            text: "Verification Code for your anonymous feed account",
    ...
    <div class="container">
        <div class="coverSection">
            <div class="imageSection">
                <img src="https://tse4.mm.bing.net/th?id=OIP.ywlP4yw1NCpdGu09pWQgiAHaEK&pid=Api&P=0&h=180" height="70" class='image' alt="Anonymous Feed's Logo" />
            </div>
            ...
            <div class="lowerSection">
                <div class="text">
                    Anonymous Feeds Services will never email you and ask you to disclose or verify your password, credit card, or banking account number.
                </div>
            </div>
        </div>
        <div class="footerText">
            This message was produced and distributed by Anonymous Feeds Services, Inc., 410 Terry Ave. South, Delhi, WA 98109. © 2022, Anonymous Feed Services, Inc. All rights reserved. AF is a registered trademark of 
...
//         <div class="coverSection">
//             <div class="imageSection">
//                 <img src="https://tse4.mm.bing.net/th?id=OIP.ywlP4yw1NCpdGu09pWQgiAHaEK&pid=Api&P=0&h=180" width="75" height="45" alt="Anonymous Feed's Logo" />
//             </div>
...
//             <hr />
//             <div class="lowerSection">
//                 <p class="cautionText">Anonymous Feed Services will never email you and ask you to disclose or verify your password, credit card, or banking account number.</p>
//             </div>
//         </div>
//         <p class="footerText">
//             This message was produced and distributed by Anonymous Feed Services, Inc., 410 Terry Ave. South, Delhi, WA 98109. © 2022, Anonymous Feed Services, Inc. All rights reserved. AF is a registered trademark of <a href="https://amazon.com" target="_blank" class="link">Amazon.com</a>, Inc. View our <a href="https://amazon.com" target="_blank" class="link">privacy policy</a>.
//         </p>
//     </div>
// </body>
// </html>
